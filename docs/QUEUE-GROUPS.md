...
**So: when an item ships, strike it in BOTH files.** `skills/batch` step 10 names the consolidated file and not this one.
...
**Items:** ~~47~~ (four bullets 272, `v221`; the builder's Clear/Delete pair 273, `v222`), ~~49~~ (274, `v223`), ~~50~~ (275, `v224`), ~~53~~ (277, `v226`), ~~54~~ (278, `v227`), 56, 59, 61, 62, 63, 64, 65, 68, 75, **96**, ~~97~~ (276, `v225`), ~~98~~ (280, `v228`), **99** · **85** (blocked)
