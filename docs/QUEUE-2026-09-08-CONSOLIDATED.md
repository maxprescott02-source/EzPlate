...
## next  47 · One modal footer pattern — **FOUR OF FIVE BULLETS SHIPPED, batch 272, `ezplate-v221`. Only the builder's Clear/Delete pair is left, and it is below.**  **[B, the same intent sits in three positions and two red-adjacent buttons on one screen mean different things]**
