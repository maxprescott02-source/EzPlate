...
var gemToken=0,gemStatus=null,gemApplied=false;   // v62: AI second-reader — token discards late/stale responses, status drives the summary note, gemApplied freezes an applied import
...
function parseInvoice(){
  ...
  gemStatus='checking'; gemApplied=false;
...
function gemFireSecondReader(text){
  ...
  try{
    if(typeof fetch!=='function'){ gemStatus='unavailable'; clearTimeout(timer); renderInvReview(); return; }
