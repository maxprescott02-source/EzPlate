...
function extractFn(src, name) {
  ...
  if (i < 0) throw new Error(`king-repoint: function not found -> ${name}. app.js changed; update tests/king-repoint.test.js`);
  ...
  throw new Error(`king-repoint: unbalanced braces for ${name}`);
}
