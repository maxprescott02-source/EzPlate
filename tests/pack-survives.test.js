...
function extractFn(src, name) {
  ...
  if (i < 0) throw new Error(`pack-survives: function not found -> ${name}. app.js changed; update tests/pack-survives.test.js`);
  ...
  throw new Error(`pack-survives: unbalanced braces for ${name}`);
}
