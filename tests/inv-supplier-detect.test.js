...
function extractFn(src, name) {
  ...
  if (i < 0) throw new Error(`inv-supplier-detect: function not found -> ${name}. app.js changed; update this test`);
  ...
  throw new Error(`inv-supplier-detect: unbalanced braces for ${name}`);
}
