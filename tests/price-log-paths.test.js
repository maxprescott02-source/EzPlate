...
function extractFn(src, name) {
  ...
  if (i < 0) throw new Error(`price-log-paths: function not found -> ${name}. app.js changed; update tests/price-log-paths.test.js`);
  ...
  throw new Error(`price-log-paths: unbalanced braces for ${name}`);
}
